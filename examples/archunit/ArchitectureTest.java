...
import static com.tngtech.archunit.lang.syntax.ArchRuleDefinition.interfaces;
...
public class ArchitectureTest {
    ...
    @ArchTest
    static final ArchRule repositoryNaming = interfaces()
    ...
    static final ArchRule packageBoundaries = classes()
        ...
        .as("All classes must reside within com.example package hierarchy "
            + "(preparation for com.example.{core,clients,storage,support} multi-module split)");
