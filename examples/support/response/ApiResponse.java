...
public class ApiResponse<T> {
	...
	public static ApiResponse<Void> error(ErrorType errorType) {
		return new ApiResponse<>(ResultType.ERROR, null, errorType.getMessage(), errorType.getCode().name());
	}

	public static ApiResponse<Void> error(ErrorType errorType, String message) {
		return new ApiResponse<>(ResultType.ERROR, null, message, errorType.getCode().name());
	}
